...
urlpatterns = [
    ...
    path('profile/', views.profile,name="profilpage"),
    path('roomdetails/', views.roomdetails,name="eoomdetails"),
    ...
    path('staff/panel/add-new-hotel', views.add_new_hotel,name="addnewhotel"),
